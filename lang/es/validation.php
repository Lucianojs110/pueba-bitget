...
return [
    ...
    | las de tamaño. Eres libre de ajustarlas a las necesidades de tu app.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'La contraseña dada en :attribute apareció en una filtración de datos. Elige otra diferente.',
    ],
    ...
    | convención "atributo.regla" para nombrar las líneas. Esto te permite
    | personalizar rápidamente un mensaje específico para una regla dada.
    |
    */

    'custom' => [
        // 'email' => [
        //     'required' => 'Necesitamos conocer tu correo electrónico.',
        // ],
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas se usan para intercambiar el placeholder :attribute
    | por un nombre más legible, como "Correo electrónico" en lugar de "email".
    | Esto ayuda a hacer los mensajes más claros para el usuario final.
    |
    */
